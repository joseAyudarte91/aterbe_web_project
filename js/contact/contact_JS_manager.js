...
var execFoundAndLoadVarsAndCustFuncs = function() {
	if(typeof foundationLoaded !== "undefined"){
		...
		$(document).foundation();
		$.getScript("../../js/contact/contact_glob_vars_and_custFuncs.js", eventHandlersSafeLoader, true);
	}
	else
...
var eventHandlersSafeLoader = function() {
	if(typeof globalVarsAndFuncsLoaded !== "undefined")
		$.getScript("../../js/contact/contact_custom_mq.js", function(){ }, true);
	else
