/****** SERVICES SECTION'S GLOBAL VARIABLES AND CUSTOM FUNCTIONS *******/
...
// Breakpoint for the appearance of the images
var SERVICES_IMG_DISPLAY_BREAKPOINT = "44.75em";
...
var mq_display_services_img_break = "only screen and (max-width: "+SERVICES_IMG_DISPLAY_BREAKPOINT+")";
...
// This function is used to customize the grid layaout breakpoint to display services's images properly. The class to set the container 100% width is added if exists, otherwise it's removed.
var customizeServicesImgWrapper = function() {
  $(".serv_sections_wrapper").toggleClass("custom_sized_wrapper_display");
};
